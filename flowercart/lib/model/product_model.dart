...
const Product({
  ...
  static List<Product> products = [
    ...
    Product(
      name: 'Balloon4', 
      category: 'Balloon Bouquet',
      imageUrl: 'https://i.pinimg.com/564x/7d/fa/12/7dfa12ee08149691fca4925c4b69121b.jpg',
      price: 2700.00, 
      isPopular: true,
      isRecommended: true),
    Product(
    ...
    Product(
      name: 'Gift3', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/16/66/0d/16660d6166b3705c211cbd04d1cac769.jpg',
      price: 2000, 
      isPopular: false,
      isRecommended: false),
    Product(
      name: 'Gift4', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/12/9a/f3/129af312c92a84ee855d00729db074c8.jpg',
      price: 1800, 
      isPopular: true,
      isRecommended: false),
    Product(
      name: 'Gift5', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/54/5b/43/545b43c3ef50486153b82c1301ef3365.jpg',
      price: 2000, 
      isPopular: false,
      isRecommended: false),
    Product(
      name: 'Gift6', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/5c/f9/a9/5cf9a94cbfe6ba98b8979779a44c1b8d.jpg',
      price: 2500, 
      isPopular: false,
      isRecommended:false),
    Product(
      name: 'Gift7', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/09/a3/15/09a315e470431c52578b152ea4ef517e.jpg',
      price: 1500, 
      isPopular: false,
      isRecommended: false),
    Product(
      name: 'Gift8', 
      category: 'Gifts',
      imageUrl: 'https://i.pinimg.com/564x/18/ea/5e/18ea5e4b1ae776c6b8fce72b715d5012.jpg',
      price: 3000, 
      isPopular: false,
      isRecommended: true),
  ];
